...
function finalCalcul() {
  ...
  $("#txtElevatorTotalPrice").attr(
    "placeholder",
    elevatorPrice.toLocaleString("en", {
      useGrouping: true,
      minimumFractionDigits: 2,
    }) + " $"
  );
  $("#txtInstallationFee").attr(
    "placeholder",
    (elevatorPrice * (fee - 1)).toLocaleString("en", {
      useGrouping: true,
      minimumFractionDigits: 2,
    }) + " $"
  );
  $("#txtTotal").attr(
    "placeholder",
    (elevatorPrice * fee).toLocaleString("en", {
      useGrouping: true,
      minimumFractionDigits: 2,
    }) + " $"
  );
