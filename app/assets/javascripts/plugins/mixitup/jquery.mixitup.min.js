...
(function (e) {
  function q(c, b, g, d, a) {
    function k() {
      ...
      a.origSort = [];
      a.checkSort = [];
      r.removeStyle(a.prefix + "filter, filter, " + a.prefix + "transform, transform, opacity, display")
        .css(a.clean)
      ...
      "list" == a.layoutMode
        ? (n.css({ display: a.targetDisplayList, opacity: "1" }), (a.origDisplay = a.targetDisplayList))
        : (n.css({ display: a.targetDisplayGrid, opacity: "1" }), (a.origDisplay = a.targetDisplayGrid));
    ...
    if (n.filter(":visible").length == c && !v.length && !b) {
      ...
      if (1 == n.length)
        return (
          "list" == a.layoutMode
            ? (d.addClass(a.listClass), d.removeClass(a.gridClass), m.css("display", a.targetDisplayList))
            : (d.addClass(a.gridClass), d.removeClass(a.listClass), m.css("display", a.targetDisplayGrid)),
          k(),
          !1
        );
    }
    ...
    if (n.length) {
      ...
      "list" == a.layoutMode
        ? (d.addClass(a.listClass), d.removeClass(a.gridClass), p.css("display", a.targetDisplayList))
        : (d.addClass(a.gridClass), d.removeClass(a.listClass), p.css("display", a.targetDisplayGrid));
      p.each(function () {
      ...
      b && w(b, g, d, a);
      if ((c = b))
        a: if (((c = a.origSort), (f = a.checkSort), c.length != f.length)) c = !1;
        else {
      ...
      m.each(function () {
        ...
        c.hasClass("mix_tohide")
          ? ((b.preTX = b.origPos.left - b.hideInterPos.left), (b.preTY = b.origPos.top - b.hideInterPos.top))
      ...
      setTimeout(function () {
        ...
        for (c = 0; 2 > c; c++)
          (d = 0 == c ? (d = a.prefix) : ""),
            (b[d + "transition"] =
              "all " + h + "ms " + a.easing + ", " + d + "filter " + h + "ms linear, opacity " + h + "ms linear"),
      ...
      return this.each(function () {
        ...
        if (b.sortOnLoad) {
          ...
          e.isArray(b.sortOnLoad)
            ? ((d = b.sortOnLoad[0]),
              (f = b.sortOnLoad[1]),
              e(b.sortSelector + "[data-sort=" + b.sortOnLoad[0] + "][data-order=" + b.sortOnLoad[1] + "]").addClass(
                "active"
              ))
            : (e(b.sortSelector + "[data-sort=" + b.sortOnLoad + "]").addClass("active"),
              (d = b.sortOnLoad),
              (b.sortOnLoad = "desc"));
          w(d, f, g, b);
        }
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            "list" == b.layoutMode
              ? h.removeStyle(b.prefix + "transition, transition").css({ display: b.targetDisplayList, opacity: 1 })
        ...
        e(b.filterSelector).bind(b.buttonEvent, function () {
          if (!b.mixing) {
            ...
            if (!1 == b.multiFilter)
              ...
              a.hasClass("active")
                ? (a.removeClass("active"), (b.filter = b.filter.replace(RegExp("(\\s|^)" + c), "")))
      ...
      return this.each(function () {
        ...
        b.mixing ||
          ...
          "undefined" !== typeof multiOut.sort &&
            (e(b.sortSelector + '[data-sort="' + multiOut.sort + '"][data-order="' + multiOut.order + '"]').addClass(
              "active"
            ),
            g.find(b.targetSelector).each(function () {
              b.startOrder.push(e(this));
