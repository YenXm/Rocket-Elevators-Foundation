  ...
  if (selection == "commercial" && document.getElementById("number-of-elevators-1").value > 0) {
    ...
    if (
      ...
      var totalOccupants =
        ...
        document.getElementById("maximum-occupancy-1").value; // 32* 51 = 1632
