          ...
          return (
            ...
            (s._jQueryInterface = function (e) {
              return this.each(function () {
                var i = t(this).data(n);
                if (
                  (i || ((i = new s(this, "object" == typeof e ? e : null)), t(this).data(n, i)), "string" == typeof e)
                ) {
            ...
            (s._dataApiKeydownHandler = function (e) {
              if (
                (/input|textarea/i.test(e.target.tagName)
                  ? !(
                      32 === e.which ||
                      (27 !== e.which && ((40 !== e.which && 38 !== e.which) || t(e.target).closest(E).length))
                    )
                  : a.test(e.which)) &&
            ...
            (T.show = function () {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                k.supportsTransitionEnd() && t(this.tip).hasClass(p)
                  ? t(this.tip).one(k.TRANSITION_END, h).emulateTransitionEnd(s._TRANSITION_DURATION)
                  : h();
              }
            }),
            (T.hide = function (e) {
