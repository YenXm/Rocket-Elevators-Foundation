...
class FactElevatorsControllerTest < ActionDispatch::IntegrationTest
  setup { @fact_elevator = fact_elevators(:one) }
  ...
  test 'should create fact_elevator' do
    assert_difference('FactElevator.count') { post fact_elevators_url, params: { fact_elevator: {} } }
  ...
  test 'should destroy fact_elevator' do
    assert_difference('FactElevator.count', -1) { delete fact_elevator_url(@fact_elevator) }
