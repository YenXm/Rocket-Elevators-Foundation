...
class BuildingsTest < ApplicationSystemTestCase
  ...
  test 'creating a Building' do
    ...
    fill_in 'Full name of the technical contact for the building',
            with: @building.full_name_of_the_technical_contact_for_the_building
    fill_in 'Phone number of ', with: @building.phone_number_of_
    fill_in 'Technical contact email for', with: @building.technical_contact_email_for
    fill_in 'Technical contact phone for the building', with: @building.technical_contact_phone_for_the_building
    fill_in 'The building', with: @building.the_building
    fill_in 'The building administrator', with: @building.the_building_administrator
